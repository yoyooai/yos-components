/**
 * Configuration loader for yos-feishu
 *
 * Loads config from ~/yos/components/feishu/config.json
 * Secrets from ~/yos/.env (FEISHU_APP_ID, FEISHU_APP_SECRET)
 */
...
export const DATA_DIR = path.join(HOME, 'yos/components/feishu');
