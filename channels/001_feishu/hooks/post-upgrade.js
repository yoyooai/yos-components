#!/usr/bin/env node
/**
 * Post-upgrade hook for yos-feishu
 *
 * Called by Claude after CLI upgrade completes (yos upgrade --json).
...
//
// Legacy yos-feishu installs (pre-bundle) have only .env credentials and
...
//                                rotations propagate after `yos upgrade feishu`
